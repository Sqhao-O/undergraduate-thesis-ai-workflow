...
⚠️ **这一步非常重要！** 请仔细核对 WorkBuddy 输出的格式要求是否与你学校的规范一致。
...
## WorkBuddy vs Lark-Formatter 对比
