...
> **一套面向 AI 小白和电脑小白的完整工作流指南，帮助你用 AI 工具高效辅助完成本科毕业论文**
...
**本工作流是开源文档性质，AI 仅作辅助工具，不提倡、不支持任何形式的学术造假。**
...
| 顺序 | 工具 | 是否必须 | 下载地址 | 用途 |
|------|------|---------|----------|------|
| **1️⃣** | **Git for Windows** | ✅ **必装！** | https://git-scm.com/downloads/win | Claude Code 内部使用 Git Bash 执行命令 |
| **2️⃣** | **Node.js** | ✅ 必须装 | https://nodejs.org/ | Claude Code 的运行环境 |

> ⚠️ **Windows 用户特别注意：没有 Git，Claude Code 根本跑不起来！**  
> 详见 [`docs/01-claude-code-setup.md`](docs/01-claude-code-setup.md) 中的「安装 Git for Windows」完整教程。
...
> 💡 **详细安装教程和问题排查 → [`docs/01-claude-code-setup.md`](docs/01-claude-code-setup.md)**
...
👉 查看 [`docs/02-cc-switch-guide.md`](docs/02-cc-switch-guide.md)
...
👉 查看 [`docs/03-pandoc-usage.md`](docs/03-pandoc-usage.md)
...
👉 查看 [`docs/05-workbuddy-guide.md`](docs/05-workbuddy-guide.md)
...
> 💡 详细安装教程 → [`docs/01-claude-code-setup.md`](docs/01-claude-code-setup.md) 的「安装 Git for Windows」章节
...
> 💡 **更多细节：** CC Switch 配置密钥 → [`docs/02-cc-switch-guide.md`](docs/02-cc-switch-guide.md) | 完整工作流图解 → [`docs/04-workflow-guide.md`](docs/04-workflow-guide.md)
...
```
┌─────────────────┐
│  ✅ README.md   │ ← 你在这里！（项目总览 + 快速开始）
│    主文档        │
└────────┬────────┘
         │ ⬇️ 点击开始
         ▼
┌───────────────────────────────────────────────────────┐
│  第1步：01-claude-code-setup.md                        │
│  （Git安装 + Node.js + Claude Code配置 + 跳过登录）      │
└────────┬───────────────────────────────────────────────┘
         │ ⬇️
         ▼
┌───────────────────────────────────────────────────────┐
│  第2步：02-cc-switch-guide.md                          │
│  （CC Switch下载 + API密钥配置 + Provider切换）          │
└────────┬───────────────────────────────────────────────┘
         │ ⬇️
         ▼
┌───────────────────────────────────────────────────────┐
│  第3步：03-pandoc-usage.md                             │
│  （Pandoc安装验证 + Markdown→DOCX转换详解）             │
└────────┬───────────────────────────────────────────────┘
         │ ⬇️
         ▼
┌───────────────────────────────────────────────────────┐
│  第4步：04-workflow-guide.md                           │
│  （完整工作流8阶段图解 + 时间规划 + 工具协作关系）        │
└────────┬───────────────────────────────────────────────┘
         │ ⬇️
         ▼
┌───────────────────────────────────────────────────────┐
│  第5步：05-workbuddy-guide.md                          │
...
| **1** | `01-claude-code-setup.md` | Git 安装 / Node.js 安装 / Claude Code 安装与验证 / 跳过登录 / 常用指令 | [📖 开始阅读 →](./docs/01-claude-code-setup.md) |
| **2** | `02-cc-switch-guide.md` | CC Switch 下载安装 / 添加 Provider / 配置 API 密钥 / MCP 管理 | [📖 阅读 →](./docs/02-cc-switch-guide.md) |
| **3** | `03-pandoc-usage.md` | Pandoc 安装验证 / 支持格式列表 / 转换命令 / Word模板使用 / 中文处理 | [📖 阅读 →](./docs/03-pandoc-usage.md) |
| **4** | `04-workflow-guide.md` | 完整工作流 8 阶段图解 / Markdown写作规范 / 时间规划建议 | [📖 阅读 →](./docs/04-workflow-guide.md) |
| **5** | `05-workbuddy-guide.md` | WorkBuddy 安装 / Paper Check Skill / 自动排版实战 / 对比报告 | [📖 阅读 →](./docs/05-workbuddy-guide.md) |
